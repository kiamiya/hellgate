...
-- EXAMPLE SCRIPTS
----------------------
examples_myth.startAP();	-- auto pot
examples_myth.startAS({["major health potion"]=20, ["major mana potion"]=20, ["scrying stone"]=20});  -- auto shopper
examples_myth.startAI();	-- auto interactor
require("ItemArray");	-- auto pickit
...
register({"STARTUP", "INGAME"}, function(e)
	--myth_move_setMoveSpeed_C(4); -- move speed multiplier (use with caution)
	myth_cam.spec();  -- a cooler camera
end);
